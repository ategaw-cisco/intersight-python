...
class StoragePhysicalDisk(object):
    ...
    def physical_disk_extension(self):
        ...
        A collection of references to the [storage.PhysicalDiskExtension](mo://storage.PhysicalDiskExtension) Managed Object.  When this managed object is deleted, the referenced [storage.PhysicalDiskExtension](mo://storage.PhysicalDiskExtension) MO unsets its reference to this deleted MO. 
